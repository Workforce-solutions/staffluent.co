...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes. Staffluent offers a 14‑day full‑access free trial, enabling you to explore every feature without any obligation or credit card requirement.",
    },
    {
    ...
    {
      question:
        "Can Staffluent be customized to fit our specific business processes?",
      answer:
        "Absolutely. Staffluent offers extensive customization options, including configurable dashboards, custom workflows, and role‑based permissions. We work closely with customers of all sizes to tailor the platform to their unique operational needs.",
    },
    {
      question: "What kind of support can we expect with Staffluent?",
      answer:
        "Our dedicated support team provides priority assistance, comprehensive onboarding, and ongoing technical support to ensure that your organization maximizes the value of the platform. We offer tailored consultation for enterprise customers while maintaining high-quality service for all users.",
    },
    {
      question: "How does Staffluent drive operational efficiency?",
      answer:
        "By consolidating project management, time tracking, quality control, and communication into a single platform, Staffluent minimizes administrative overhead and improves workflow coordination. Its real‑time insights and AI‑powered analytics help identify bottlenecks and optimize resource allocation.",
    },
    {
      question: "What is the typical implementation process?",
      answer:
        "We work collaboratively with your team to ensure a smooth implementation. The process includes a detailed planning phase, configuration tailored to your business processes, comprehensive training sessions, and ongoing support to ensure a seamless transition and rapid adoption.",
    },
  ];
