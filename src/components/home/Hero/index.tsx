    ...
    <section className="pt-10 w-full overflow-x-hidden">
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 flex flex-col items-center text-center">
        ...
        <div className="relative w-full mt-20">
          {/* Dashboard Preview */}
          <div className="w-[min(90vw,1140px)] mx-auto backdrop-blur-[6px] bg-gradient-to-b from-white to-white/20 rounded-[24px] p-1.5 shadow-lg overflow-visible relative z-10 opacity-100">
          ...
          <div className="w-[115%] mt-[-80px] mx-auto left-1/2 -translate-x-1/2 relative">
            <div className="w-full bg-[#111111] rounded-[48px] pt-48 pb-16 px-4 md:px-20">
              {/* Caption */}
