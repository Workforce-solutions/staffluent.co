      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="text-base md:text-lg text-[#3d495b] max-w-[600px] mx-auto mt-4 md:mt-6">
            The ultimate cloud‑based platform for project tracking, time &
            attendance, quality inspections, and client management.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <span className="text-[#3d495b] text-sm md:text-base">
              View Pricing
            </span>
          </div>
        </motion.div>
