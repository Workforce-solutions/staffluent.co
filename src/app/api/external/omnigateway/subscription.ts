...
import { SubscriptionFinalizationResponse, SubscriptionPlan, SubscriptionResponse } from './types/subscription-plan';
...
export const createBusinessApi = () => {
    ...
    return {
      ...
      finalizeSubscription: async (
        ...
        const { data } = await api.get(`/businesses/subscription/finalize?session_id=${sessionId}`);
        return data;
      }
    };
  };